    ...
    <Box>
        ...
        <div>
            <form @submit.prevent="makeOffer">
                ...
                <input type="range" :min="min" :max="max" step="10000" v-model.number="form.amount"
                       class="w-full h-4 mt-4 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"/>
...
const emits = defineEmits(['offerUpdated']);

watch(() => form.amount, debounce((value) => emits('offerUpdated', value)))
</script>
