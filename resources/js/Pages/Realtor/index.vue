            ...
            <div class="flex flex-col md:flex-row gap-2 md:items-center justify-between">
                ...
                <div class="flex items-center gap-1 text-gray-600 dark:text-gray-300">
                    ...
                    <Link class="btn-outline text-xs font-medium"
                          :href="route('realtor.listing.edit',{listing: listing.id})">Edit
                    </Link>
                    ...
                    <Link v-if="listing.deleted_at" :href="route('realtor.listing.restore',{ listing:listing.id})"
                          as="button" method="put"
                          class="btn-outline text-xs font-medium">Restore
                    </Link>
                </div>
            </div>
        </Box>
